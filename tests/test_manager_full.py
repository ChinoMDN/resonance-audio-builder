...
from resonance_audio_builder.core.exceptions import RecoverableError, FatalError
...
class TestManagerFullCoverage:
    ...
    def manager(self):
        ...
        with patch("resonance_audio_builder.core.manager.RichUI"), \
    ...
    async def test_process_track_recoverable_retry(self, manager):
        ...
        manager.searcher.search = AsyncMock(side_effect=[
            RecoverableError("Network Glitch"), 
            search_res
        ])
        manager.downloader.download = AsyncMock(return_value=DownloadResult(True, 1024))
    ...
    async def test_run_flow(self, manager):
        ...
        # Mock Dependencies
        with patch("resonance_audio_builder.core.manager.Confirm.ask", return_value=True), \
    ...
    def test_print_batch_summary(self, manager):
        ...
        with patch("resonance_audio_builder.core.manager.console.print") as mock_print, \
             patch("resonance_audio_builder.core.manager.Panel") as mock_panel, \
