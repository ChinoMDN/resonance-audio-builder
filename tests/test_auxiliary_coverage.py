...
from resonance_audio_builder.network.limiter import CircuitBreaker, RateLimiter
...
class TestCoverageBooster:
    ...
    def test_tagging_write_full(self, tmp_path):
        ...
        track = TrackMetadata(track_id="id_123", title="Test", artist="Artist", raw_data={})
