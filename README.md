...
[![CI](https://github.com/ChinoMDN/Resonance-Music-Downloader/actions/workflows/ci.yml/badge.svg)](https://github.com/ChinoMDN/Resonance-Music-Downloader/actions)
...
```bash
git clone https://github.com/ChinoMDN/Resonance-Music-Downloader.git
cd Resonance-Music-Downloader
...
```json
{
    "output_folder_hq": "Downloads_HQ",
    "output_folder_mobile": "Downloads_Mobile",
...
| ------------------------ | ------------------ | --------------------------------------- |
| `output_folder_hq`       | `Downloads_HQ`     | Folder for high-quality output          |
| `output_folder_mobile`   | `Downloads_Mobile` | Folder for low-bitrate output           |
...
Some media sources may require authenticated access.
Resonance supports optional cookie-based requests for these cases.
