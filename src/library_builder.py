"""
Resonance Music Downloader v6.0 
=============================================================
What's new in v6.0:
...
@dataclass
class Config:
    OUTPUT_FOLDER_HQ: str = 'Downloads_HQ'
    OUTPUT_FOLDER_MOBILE: str = 'Downloads_Mobile'
    ERROR_FILE: str = 'canciones_fallidas.txt'
    ERROR_CSV: str = 'canciones_fallidas.csv'
    CHECKPOINT_FILE: str = 'progreso.json'
    CACHE_FILE: str = 'youtube_cache.json'
    COOKIES_FILE: str = 'cookies.txt'
    CONFIG_FILE: str = 'config.json'
    HISTORY_FILE: str = 'historial.json'
